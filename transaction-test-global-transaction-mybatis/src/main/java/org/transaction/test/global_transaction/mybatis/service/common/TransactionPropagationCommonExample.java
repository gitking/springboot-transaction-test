package org.transaction.test.global_transaction.mybatis.service.common;

public interface TransactionPropagationCommonExample {
    ...
    void notransaction_exception_required_notSupport();

    void notransaction_required_notSupport_exception();

    void transaction_exception_required_notSuppored();

    void transaction_required_notSupported_exception();
